                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('transaksi.update',['transaksi'=>$transaksi->id]) }}" method="post">
                        ...
                        <label class="block my-3">
                            ...
                            <input type="number" class="mt-0 block w-full px-0.5 mx-5 border-0 border-b-2 border-gray-200 focus:ring-0 focus:border-blue-400" value="{{ $transaksi->uang }}" name="uang" />
                        </label>
                        <label class="block my-3">
