            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class=" inline-block m-2 md:m-5 border border-green-300 bg-green-400 text-white md:py-1 md:px-5 p-1 rounded">
                        <a href="{{ route('user.create') }}"><i class="fas fa-plus-circle"></i> Create</a>
                    </div>
                                    ...
                                    <td class="border border-gray-600">
                                        <div class="flex flex-auto">
                                            <div x-data="{ tooltip: false }" class="relative z-30 inline-flex mx-1">
                                                <a href="{{ route('user.show',['user'=>$item->id]) }}" x-on:mouseover="tooltip = true" x-on:mouseleave="tooltip = false" class="rounded-md px-3 py-2 bg-blue-500 text-white cursor-pointer shadow">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <div class="relative" x-cloak x-show.transition.origin.top="tooltip">
                                                    <div class="absolute top-0 z-10 w-32 p-2 -mt-1 text-sm leading-tight text-white transform -translate-x-1/2 -translate-y-full bg-blue-500 rounded-lg shadow-lg">View User</div>
                                            ...
                                            <div x-data="{ tooltip: false }" class="relative z-30 inline-flex mx-1">
                                                <a href="{{ route('user.edit',['user'=>$item->id]) }}" x-on:mouseover="tooltip = true" x-on:mouseleave="tooltip = false" class="rounded-md px-3 py-2 bg-yellow-500 text-white cursor-pointer shadow">
                                                    <i class="fas fa-pen"></i>
                                                </a>
                                                <div class="relative" x-cloak x-show.transition.origin.top="tooltip">
                                                    <div class="absolute top-0 z-10 w-32 p-2 -mt-1 text-sm leading-tight text-white transform -translate-x-1/2 -translate-y-full bg-yellow-500 rounded-lg shadow-lg">Edit User</div>
                                        ...
                                        <form action="{{ route('user.destroy',['user'=>$item->id]) }}" method="post">
                                            ...
                                            <div x-data="{ tooltip: false }" class="relative z-30 inline-flex mx-1">
                                                ...
                                                <div class="relative" x-cloak x-show.transition.origin.top="tooltip">
                                                    <div class="absolute top-0 z-10 w-32 p-2 -mt-1 text-sm leading-tight text-white transform -translate-x-1/2 -translate-y-full bg-red-500 rounded-lg shadow-lg">Delete User</div>
